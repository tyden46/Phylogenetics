...
setwd("C:\\Users\\tyson\\OneDrive\\Desktop\\Coronavirus Proteins\\Reference_Nucleotide_Sequences\\Hackensack")
...
write.table(cbind(row.names(myTable),myTable), file="SequenceTableHackensack.csv", quote=FALSE, sep=",", row.names = FALSE)
